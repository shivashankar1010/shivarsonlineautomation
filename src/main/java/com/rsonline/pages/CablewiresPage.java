...
public class CablewiresPage extends BasePage {
    ...
    public CablewiresPage(WebDriver driver) {
        super(driver);
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }

    public void verifyCablewirecateggory()

    {
        //findAndClickElementUsingText();
       // driver.findElement((By.ByPartialLinkText("Connectors")).click();)
    }
